$("#showButton").on("click", function () {
    let jsonString = $("#textInput").val();
    let jsonObject = JSON.parse(jsonString);
    console.log(jsonObject);
    getChildren();
    getFriends();
    $("#windowPerson").html(`${jsonObject.firstName} ${jsonObject.lastName}`);
    $("#windowPersonDetails").html(jsonObject.email);
    $("#windowPersonDetails").append("<br>", jsonObject.phone);

    function getChildren() {
        for (let i = 0; i < jsonObject['children'].length; i++) {
            let childFirstName = jsonObject.children[i].firstName;
            let childGender = jsonObject.children[i].gender;
            let childBirth = getDate(jsonObject.children[i].birth);
            $("#windowPersonChildren").append(`${childFirstName} ${childGender} ${childBirth}<br>`);
        }
    }

    function getFriends() {
        for (let i = 0; i < jsonObject['friends'].length; i++) {
            let friendFirstName = jsonObject.friends[i].firstName;
            let friendLastName = jsonObject.friends[i].lastName;
            let friendGender = jsonObject.friends[i].gender;
            let friendProfession = jsonObject.friends[i].profession;
            let friendBirth = getDate(jsonObject.friends[i].birth);
            $("#windowPersonFriends").append(`${friendFirstName} ${friendLastName}, (${friendGender}) ${friendBirth}, ${friendProfession}<br>`);
        }
    }
...
/* {
    ...
    "lastName": "Karadeniz",
    "gender": "M",
    "birth": "1978-08-04T22:00:00.000Z",
    ...
    "children": [{
        "firstName": "Büsra",
        "gender": "M",
        "birth": "2007-06-04T22:00:00.000Z",
        ...
        "firstName": "Serhat",
        "gender": "F",
        "birth": "2009-07-04T22:00:00.000Z",
        ...
        "firstName": "Elif",
        "gender": "F",
        "birth": "2011-08-04T22:00:00.000Z",
        ...
        "firstName": "Ali",
        "gender": "M",
        "birth": "2018-09-04T22:00:00.000Z",
    ...
    "address": {"street": "Matternhornstr. 123", "zip": "8604", "city": "Volketswil", "country": "CH"},
    "languages": ["EN", "DE", "TR"],
    "salary": 53000,
    "friends": [{
        "firstName": "Hakan",
        "lastName": "Basak",
        "gender": "M",
        "birth": "1974-02-04T23:00:00.000Z",
        "profession": "Engineer",
        "salary": 104000,
        ...
        "address": {"street": "Seegartenstr. 55", "zip": "9000", "city": "St.Gallen", "country": "CH"}
    }, {
        "firstName": "Selami",
        "lastName": "Has",
        "gender": "M",
        "birth": "1965-12-01T23:00:00.000Z",
        "profession": "Manager",
        "salary": 78000,
        ...
        "address": {"street": "Dorfstrasse 9", "zip": "8000", "city": "Zürich", "country": "FR"}
    }, {
        "firstName": "Katherina",
        "lastName": "Kusuva",
        "gender": "F",
        "birth": "1983-05-03T22:00:00.000Z",
        ...
        "salary": 99000,
        "address": {"street": "Petersburgstreet 9", "zip": "74000", "city": "Moscow", "country": "RU"}
    }]
} */